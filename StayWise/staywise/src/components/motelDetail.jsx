...
const MotelDetail = ({ match }) => {
  ...
  const fetchMotel = async () => {
    try {
      const response = await axios.get(`http://98.81.233.189:5000/motel/${id}`);
  ...
  const fetchAverages = async () => {
    try {
      const response = await axios.get(`http://98.81.233.189:5000/reviews/averages/${id}`);
  ...
  const fetchReviews = async (page = 1) => {
    try {
      const response = await axios.get(`http://98.81.233.189:5000/reviews/${id}?page=${page}`);
  ...
  const logInteraction = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://98.81.233.189:5000/log-one-interaction', {
  ...
  const fetchPhotos = async () => {
    try {
      const response = await axios.get(`http://98.81.233.189:5000/reviews/photos/${id}`);
